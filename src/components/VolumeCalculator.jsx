...
import { useVolumeCalculator } from '../hooks/useVolumeCalculator.js';
...
const VolumeCalculator = () => {
  ...
  return (
    <div className="bg-white/10 backdrop-blur-2xl rounded-3xl border border-white/20 shadow-2xl max-w-2xl mx-auto p-6">
      <div className="mb-6">
        <label className="block text-white/80 text-sm mb-2">Sólido geométrico</label>
        <select
          value={shape}
      ...
      <div className="flex gap-3 mb-6">
        <Button onClick={calculateVolume} className="bg-blue-500/30 hover:bg-blue-500/40 flex-1">
          Calcular Volume
        </Button>
